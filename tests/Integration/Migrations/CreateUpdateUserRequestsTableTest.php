...
class UpdateUserRequestsMigrationTest extends TestCase
{
    use RefreshDatabase;

    protected string $migrationPath = 'database/migrations/2025_07_15_223838_create_update_user_requests_table.php';
    protected string $tableName = 'update_user_requests';
    protected string $table = 'update_user_requests';
    ...
    public function test_update_user_requests_table_exists(): void
    {
     ...
     */
    public function test_update_user_requests_table_migration_runs_successfully_and_creates_columns(): void
    {
        Artisan::call('migrate', ['--path' => $this->migrationPath]);
     ...
     */
    public function test_update_user_requests_table_migration_does_not_create_if_exists(): void
    {
     ...
     */
    public function test_update_user_requests_table_migration_rollback_removes_table_and_columns(): void
    {
        Artisan::call('migrate', ['--path' => $this->migrationPath]);
        $this->assertTrue(Schema::hasTable($this->table));
