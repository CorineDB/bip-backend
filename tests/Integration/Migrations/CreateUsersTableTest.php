...
class UsersMigrationTest extends TestCase
{
    ...
    protected string $migrationPath = 'database/migrations/2025_07_15_221525_create_users_table.php';
     ...
     */
    public function test_users_table_migration_runs_successfully_and_creates_columns(): void
    {
        Artisan::call('migrate', ['--path' => $this->migrationPath]);
     ...
     */
    public function test_users_table_migration_does_not_create_if_exists(): void
    {
     ...
     */
    public function test_users_table_migration_rollback_removes_table_and_columns(): void
    {
        Artisan::call('migrate', ['--path' => $this->migrationPath]);
        $this->assertTrue(Schema::hasTable($this->table));
