...
## Vue d'ensemble
Ce rapport présente la structure complète du système de gestion des idées de projets développé en Laravel, incluant les schémas de base de données, l'architecture du code et les relations entre les composants.
...
CREATE TABLE organisations (
    ...
    type ENUM('dpaf', 'dgpd', 'dgb', 'ministere', 'etatique', 'ong', 'partenaire') DEFAULT 'etatique',
