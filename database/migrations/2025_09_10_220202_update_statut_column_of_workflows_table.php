...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $existingStatuts = DB::table('workflows')->distinct()->pluck('sous_phase')->toArray();
        ...
        // Supprimer la contrainte existante
        DB::statement('ALTER TABLE workflows DROP CONSTRAINT IF EXISTS workflows_sous_phase_check');

        // Ajouter la nouvelle contrainte qui couvre les valeurs existantes + les nouvelles
        DB::statement("ALTER TABLE workflows ADD CONSTRAINT workflows_sous_phase_check CHECK (sous_phase::text = ANY (ARRAY['" . implode("','", $allowedStatuts) . "']::text[]))");
