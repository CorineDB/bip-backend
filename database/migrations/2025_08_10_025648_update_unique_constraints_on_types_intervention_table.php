...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('types_intervention', function (Blueprint $table) {
            ...
            $table->dropUnique('types_intervention_type_intervention_unique');

            // Ajoute la contrainte unique composite
            $table->unique(['secteurId', 'type_intervention'], 'types_intervention_secteurId_slug_unique');
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('types_intervention', function (Blueprint $table) {
            ...
            $table->dropUnique('types_intervention_secteurId_slug_unique');

            // Remettre les contraintes uniques sur 'nom' et 'slug' (si besoin)
            $table->unique('type_intervention', 'types_intervention_type_intervention_unique');
        });
    }
};
