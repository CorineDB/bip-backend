...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('villages', function (Blueprint $table) {
            ...
            $table->dropUnique('villages_code_unique');

            // Ajoute la contrainte unique composite
            $table->unique(['arrondissementId', 'code', 'slug'], 'villages_slug_arrondissementId_unique');
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('villages', function (Blueprint $table) {
            ...
            $table->dropUnique('villages_slug_arrondissementId_unique');

            // Remettre les contraintes uniques sur 'nom' et 'slug' (si besoin)
            $table->unique('code', 'villages_code_unique');
