...
class CanevasAppreciationTdrPrefaisabiliteSeeder extends Seeder
{
    protected $documentData = [
        'nom' => 'Canevas de rédaction des TDRs de préfaisabilité',
        'slug' => 'canevas-appreciation-tdrs-prefaisabilite',
        'description' => 'Canevas de rédaction des termes de référence de préfaisabilité',
        'type' => 'checklist',
        'evaluation_configs' => [
            'criteres_evaluation' => [
                ...
                'regles_decision' => [
                    'passe' => [
                        ...
                        'statut_final' => 'validé',
                        'notification' => [
                            'titre' => 'TDR de préfaisabilité Validé',
                            'message' => 'Le terme de reference de l\'étude de préfaisabilité a été validé avec succès',
                            'type' => 'success',
                        ],
                    ],
                    'retour' => [
                        'condition' => 'has_retour_but_acceptable',
                        'description' => 'Réservé pour un travail supplémentaire',
                        ...
                        'notification' => [
                            'titre' => 'TDR de préfaisabilité à Améliorer',
                            'message' => 'Le terme de reference de l\'étude de préfaisabilité nécessite des améliorations avant validation',
                            'type' => 'warning',
                        ],
                    ],
                    'non_accepte' => [
                        ...
                        'description' => 'Rejeté',
                        'message' => 'Le terme de reference de l\'étude de préfaisabilité ne répond pas aux critères minimums',
                        'statut_final' => 'rejete',
                        'triggers' => [
                            'incomplete_questions' => 'Si des questions n\'ont pas été complétées',
                            'has_non_accepte' => 'Si une réponse à une question a été évaluée comme « Rejeté »',
                            'too_many_retour' => 'Si 10 ou plus des réponses ont été évaluées comme « Réservé »',
                        ],
                        'notification' => [
                            'titre' => 'TDR de préfaisabilité Rejeté',
                            'message' => 'Le terme de reference de l\'étude de préfaisabilité ne répond pas aux critères minimums requis',
                            'type' => 'error',
                        ],
                    ],
                ],
                'algorithme_decision' => [
                    'etapes' => [
                        ...
                        [
                            ...
                            'description' => 'Vérifier qu\'aucune question n\'a été évaluée comme \'Rejeté\'',
                            'action_si_echec' => 'non_accepte',
                        ],
                        [
                            'ordre' => 3,
                            'condition' => 'count_retour',
                            'description' => 'Compter le nombre de \'Réservé\'',
                            'seuil_max' => 9,
        ...
        'forms' => [
            [
                ...
                'ordre_affichage' => 1,
                'key' => 'section-objectif-justification',
                'intitule' => 'Objectif et justification d\'un nouveau projet',
                ...
                'elements' => [
                    [
                        ...
                        'key' => 'reponse_objectifs_politiques',
                    ...
                    [
                        ...
                        'key' => 'consequences_non_mise_oeuvre',
            ...
            [
                'element_type' => 'section',
                'ordre_affichage' => 2,
                'key' => 'section-informations-financieres',
                'intitule' => 'Informations financières',
                ...
                'elements' => [
                    ...
                    [
                        ...
                        'key' => 'couts_recurrents_operation',
                    ...
                    [
                        ...
                        'key' => 'expropriation_reinstallation',
            ...
            [
                'element_type' => 'section',
                'ordre_affichage' => 3,
                'key' => 'section-planification-mise-oeuvre',
                'intitule' => 'Planification de la mise en œuvre',
    ...
    public function run(): void
    {
        ...
        try {
            $categorieDocument = CategorieDocument::updateOrCreate([
                'slug' => 'canevas-appreciation-tdr-prefaisabilite'
            ], [
                'nom' => "Canevas appreciation tdr prefaisabilite",
                'slug' => 'canevas-appreciation-tdr-prefaisabilite',
                'format' => 'checklist'
            ]);
