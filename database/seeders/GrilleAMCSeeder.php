...
class GrilleAMCSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $categorieCritere = \App\Models\CategorieCritere::firstOrCreate([
            'slug' => 'grille-analyse-multi-critere',
        ], [
            'type' => "Grille d'analyse multicritères",
            'slug' => 'grille-analyse-multi-critere',
            'is_mandatory' => true
        ]);
        ...
        foreach ($notationsImpactClimatique as $notation) {
            \App\Models\Notation::firstOrCreate([
                'libelle' => $notation['libelle'],
