...
class CanevasAppreciationTdrFaisabiliteSeederCP extends Seeder
{
        ...
        "evaluation_configs" => [
            ...
            "criteres_evaluation" => [
                ...
                "notifications" => [
                    "passe" => [
                        "titre" => "TDR Validé",
                        "message" => "Le TDR de faisabilité a été validé avec succès",
                        "type" => "success"
                    ],
                    "retour" => [
    ...
    public function run(): void
    {
        ...
        try {
            ...
            $categorieDocument = CategorieDocument::where('slug', 'canevas-appreciation-tdrs-faisabilite')->first();
