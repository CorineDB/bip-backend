    ...
    protected $documentData = [
            ...
            'criteres_evaluation' => [
                ...
                'regles_decision' => [
                    'passe' => [
                        ...
                        'statut_final' => 'validé',
                        'notification' => [
                            'titre' => 'TDR de faisabilité Validé',
                            'message' => 'Le terme de reference de l\'étude de faisabilité a été validé avec succès',
                            'type' => 'success',
                        ],
                    ],
                    'retour' => [
                        ...
                        'notification' => [
                            'titre' => 'TDR de faisabilité à Améliorer',
                            'message' => 'Le terme de reference de l\'étude de faisabilité nécessite des améliorations avant validation',
                            'type' => 'warning',
                        ],
                    ],
                    'non_accepte' => [
                        ...
                        'description' => 'Rejeté',
                        'message' => 'Le terme de reference de l\'étude de faisabilité ne répond pas aux critères minimums',
                        'statut_final' => 'rejete',
                        'triggers' => [
                        ...
                        'notification' => [
                            'titre' => 'TDR de faisabilité Rejeté',
                            'message' => 'Le terme de reference de l\'étude de faisabilité ne répond pas aux critères minimums requis',
                            'type' => 'error',
                        ],
                    ],
                ],
        ...
        'forms' => [
            [
                ...
                'ordre_affichage' => 1,
                'key' => 'section-objectif-justification-1',
            ...
            [
                'element_type' => 'section',
                'ordre_affichage' => 2,
                'key' => 'section-informations-financieres-1',
            ...
            [
                'element_type' => 'section',
                'ordre_affichage' => 3,
                'key' => 'section-planification-mise-oeuvre-1',
