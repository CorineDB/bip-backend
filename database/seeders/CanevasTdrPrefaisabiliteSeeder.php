...
class CanevasTdrPrefaisabiliteSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $categorie = CategorieDocument::firstOrCreate([
            ...
            'nom' => 'Canevas des TDRs de préfaisabilité',
            'description' => 'Catégorie pour les canevas de rédaction des termes de référence de préfaisabilité',
            "format" => "formulaire"
        ]);

        // Créer le document canevas
        $document = Document::updateOrCreate([
            'slug' => 'canevas-redaction-tdr-prefaisabilite'
        ], [
        ...
        $this->command->info('Canevas de rédaction des TDRs de préfaisabilité créé avec succès');
    }
