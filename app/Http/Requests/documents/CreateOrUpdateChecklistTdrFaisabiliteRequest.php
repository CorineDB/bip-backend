...
class CreateOrUpdateChecklistTdrFaisabiliteRequest extends FormRequest
{
    private $canevas_redaction_tdr_faisabilite = null;
    ...
    {
        $this->canevas_redaction_tdr_faisabilite = Document::whereHas('categorie', function ($query) {
                ...
                function ($attribute, $value, $fail) {
                    $exists = Document::where('nom', $value)
                        ->whereHas('categorie', function ($query) {
                            $query->where('slug', 'canevas-tdr-faisabilite');
                        })->when($this->canevas_redaction_tdr_faisabilite, function($query){
                            $query->where("id","<>", $this->canevas_redaction_tdr_faisabilite->id);
                        })->exists();
