...
class CreateOrUpdateCanevasRedactionNoteConceptuelleRequest extends FormRequest
{
    private $canevas_redaction_note_conceptuelle = null;
    ...
    public function prepareForValidation(){
        ...
        $this->canevas_redaction_note_conceptuelle = Document::whereHas('categorie', function ($query) {
    ...
    public function rules(): array
    {
        return [
            ...
            'nom' => [
                ...
                function ($attribute, $value, $fail) {
                    $exists = Document::where('nom', $value)
                        ...
                        })->when($this->canevas_redaction_note_conceptuelle, function($query){
                            $query->where("id","<>", $this->canevas_redaction_note_conceptuelle->id);
                        })
                        ->exists();
            ...
            'sections.*.id' => ["sometimes"/* Rule::requiredIf($this->canevas_redaction_note_conceptuelle) */, Rule::exists('champs_sections', 'id')->whereNull('deleted_at')],
            ...
            'sections.*.champs.*.id' => ["sometimes"/* Rule::requiredIf($this->canevas_redaction_note_conceptuelle) */, Rule::exists('champs', 'id')->whereNull('deleted_at')],
            ...
            'champs.*.id' => ["sometimes"/* Rule::requiredIf($this->canevas_redaction_note_conceptuelle) */, Rule::exists('champs', 'id')->whereNull('deleted_at')],
