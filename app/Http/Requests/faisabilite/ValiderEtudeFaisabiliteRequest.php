...
class ValiderEtudeFaisabiliteRequest extends FormRequest
{
    ...
    {
        return [
            'action' => 'required|string|in:maturite, reviser,abandonner',
            'commentaire' => 'nullable|string|max:2000',
            'checklist_controle' => 'nullable|array',
            'checklist_controle.*.critere' => 'required|string',
            'checklist_controle.*.validation' => 'required|boolean',
            'checklist_controle.*.commentaire' => 'nullable|string|max:500'
        ];
    }
