...
class UpdateGrilleEvaluationClimatiqueRequest extends FormRequest
{
    protected $categorie;
    ...
    public function prepareForValidation(): void
    {
        ...
        $this->categorie = app(CategorieCritereRepository::class)->findByAttribute('slug', 'evaluation-preliminaire-multi-projet-impact-climatique');
    }
