...
class SoumettreEvaluationClimatiqueIdeeRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->categorieCritere = CategorieCritere::where('slug', 'evaluation-preliminaire-multi-projet-impact-climatique')
            ->first();
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'reponses.*.critere_id' => [
                'required',
                new HashedExists(Critere::class),//Rule::exists('criteres', 'id')->whereNull('deleted_at'),
