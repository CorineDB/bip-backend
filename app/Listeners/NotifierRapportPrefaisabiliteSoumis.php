...
use App\Notifications\NotificationRapportPrefaisabiliteSoumis;
use App\Models\User;
use App\Models\Dpaf;
use App\Models\Dgpd;
...
class NotifierRapportPrefaisabiliteSoumis implements ShouldQueue
{
     ...
     * Handle the event.
     */
    public function handle(RapportPrefaisabiliteSoumis $event): void
    {
        ...
        Log::info('Envoi de notifications pour soumission de rapport de préfaisabilité', [
        ...
        if ($membresDgpd->isNotEmpty()) {
            Notification::send(
                $membresDgpd,
                new NotificationRapportPrefaisabiliteSoumis(
                    $rapport,
                    $projet,
                    $soumetteur,
                    $estResoumission,
        ...
        Log::info('Notifications envoyées avec succès pour soumission de rapport de préfaisabilité', [
            'rapport_id' => $rapport->id,
            'est_resoumission' => $estResoumission,
        ]);
    }
     ...
     */
    public function failed(RapportPrefaisabiliteSoumis $event, \Throwable $exception): void
    {
        Log::error('Échec de notification RapportPrefaisabiliteSoumis', [
