...
use App\Notifications\NotificationEtudePrefaisabiliteValidee;
use App\Models\User;
use App\Models\Dpaf;
...
class NotifierEtudePrefaisabiliteValidee implements ShouldQueue
{
     ...
     * Handle the event.
     */
    public function handle(EtudePrefaisabiliteValidee $event): void
    {
        ...
        if ($rapport->soumis_par_id) {
            ...
            if ($soumetteur) {
                $soumetteur->notify(
                    new NotificationEtudePrefaisabiliteValidee(
                        $rapport,
                        $projet,
                        $evaluation,
                        $validateur,
     ...
     */
    public function failed(EtudePrefaisabiliteValidee $event, \Throwable $exception): void
    {
        Log::error('Échec de notification EtudePrefaisabiliteValidee', [
