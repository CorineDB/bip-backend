...
class NotificationRapportFaisabilitePrelimSoumis extends Notification implements ShouldQueue
{
    ...
    protected function getActionUrl(): string
    {
        ...
        return match($this->typeDestinataire) {
            'dgpd_validation' => $path . '/projet/' . $this->projet->hashed_id . '/validation-details',
            'dpaf_supervision', 'equipe_organisation' => $path . '/projet/' . $this->projet->hashed_id . '/validation-details',
            'soumetteur_confirmation' => $path . '/projet/' . $this->projet->hashed_id . '/validation-details',
