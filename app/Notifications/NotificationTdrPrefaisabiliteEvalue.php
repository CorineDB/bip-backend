...
class NotificationTdrPrefaisabiliteEvalue extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'type' => 'tdr_prefaisabilite_evalue',
    ...
    protected function getSubject(): string
    {
        ...
        return match($this->typeDestinataire) {
            'redacteur_resultat' => match($resultat) {
                'accepte' => 'TDR de préfaisabilité accepté',
                'accepte_sous_reserve' => 'TDR de préfaisabilité accepté sous réserve',
                'travail_supplementaire' => 'TDR de préfaisabilité : travail supplémentaire requis',
                'refuse' => 'TDR de préfaisabilité refusé',
                default => 'Résultat de l\'évaluation du TDR de préfaisabilité',
            },
            'dpaf_supervision' => 'Supervision : TDR de préfaisabilité évalué',
            'equipe_organisation' => 'Mise à jour : TDR de préfaisabilité évalué',
            'evaluateur_confirmation' => 'Confirmation : Évaluation du TDR enregistrée',
            default => 'TDR de préfaisabilité évalué',
        };
    }
    ...
    protected function getMessage(): string
    {
        ...
        return match($this->typeDestinataire) {
            'redacteur_resultat' =>
                'L\'évaluation de votre TDR de préfaisabilité pour le projet "' . $this->projet->titre_projet .
            ...
            'equipe_organisation' =>
                'Le TDR de préfaisabilité pour votre projet "' . $this->projet->titre_projet .
                '" a été évalué. Résultat : ' . $resultat . '.',
            'evaluateur_confirmation' =>
                'Votre évaluation du TDR de préfaisabilité pour le projet "' . $this->projet->titre_projet .
                '" a été enregistrée avec succès.',
            default =>
                'Le TDR de préfaisabilité pour le projet "' . $this->projet->titre_projet . '" a été évalué.',
        };
    }
    ...
    protected function getActionMessage(): string
    {
        ...
        return match($this->typeDestinataire) {
            'redacteur_resultat' => match($resultat) {
                'accepte' => 'Prochaine étape : Lancement de l\'étude de préfaisabilité.',
