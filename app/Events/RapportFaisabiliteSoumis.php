...
class RapportFaisabiliteSoumis implements ShouldBroadcast
{
    ...
    {
        return 'rapport.faisabilite.soumis';
    }
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'message' => $this->estResoumission
                ? 'Le rapport de faisabilité a été resoumis après révision'
                : 'Un nouveau rapport de faisabilité a été soumis',
        ];
    }
}
