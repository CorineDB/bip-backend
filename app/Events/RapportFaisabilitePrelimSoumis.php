...
class RapportFaisabilitePrelimSoumis implements ShouldBroadcast
{
    ...
    {
        return 'rapport.faisabilite.prelim.soumis';
    }
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'message' => $this->estResoumission
                ? 'Le rapport de faisabilité préliminaire a été resoumis après révision'
                : 'Un nouveau rapport de faisabilité préliminaire a été soumis',
        ];
    }
}
