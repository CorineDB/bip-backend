...
class TestExportProjectPdfJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'test:export-pdf {idee_projet_id}';
     ...
     * @var string
     */
    protected $description = 'Tester l\'export PDF d\'une idée de projet via le système de jobs';
    ...
    public function handle()
    {
        ...
        $this->info("Dispatching du job ExportProjectPdfJob...");

        ExportProjectPdfJob::dispatch($ideeProjetId, auth()->id() ?? 1);
