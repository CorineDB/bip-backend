...
use App\Repositories\Contracts\CanevaRepositoryInterface;
use App\Services\Contracts\CanevasServiceInterface;

class CanevasService extends BaseService implements CanevasServiceInterface
{
    protected BaseRepositoryInterface $repository;
    protected ApiResourceInterface $resource;

    public function __construct(
        CanevaRepositoryInterface $repository,
