...
/**
 * Script pour régénérer le seeder de checklist de suivi assurance qualité rapport faisabilité préliminaire
 * Usage: php scripts/regenerate_faisabilite_preliminaire_seeder.php
 */
...
echo "🔍 Extraction de la checklist de suivi assurance qualité faisabilité préliminaire...\n\n";

$checklist = $documentRepo->getCanevasChecklisteSuiviControleQualiteRapportEtudeFaisabilitePreliminaire();
...
$resource = new \App\Http\Resources\CanevasAppreciationTdrResource($checklist);
...
$seederContent = generateSeederContent($documentData, $data['slug']);

// Écrire le fichier seeder
$seederPath = __DIR__ . "/../database/seeders/ChecklistSuiviAssuranceQualiteRapportFaisabilitePreliminaireSeeder.php";
