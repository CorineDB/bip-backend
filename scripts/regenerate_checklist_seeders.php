...
/**
 * Script pour régénérer les seeders de checklists à partir du contenu existant en base de données
 * Usage: php scripts/regenerate_checklist_seeders.php
 */
...
$checklists = [
    'ChecklistEtudeFaisabiliteEconomiqueSeeder' => [
        'method' => 'getCanevasChecklisteEtudeFaisabiliteEconomique',
        'categorie_slug' => 'canevas-check-liste-etude-faisabilite-economique',
    ],
    'ChecklistEtudeFaisabiliteTechniqueSeeder' => [
        'method' => 'getCanevasChecklisteEtudeFaisabiliteTechnique',
        'categorie_slug' => 'canevas-check-liste-etude-faisabilite-technique',
    ],
    'ChecklistEtudeFaisabiliteMarcheSeeder' => [
        'method' => 'getCanevasChecklisteEtudeFaisabiliteMarche',
        'categorie_slug' => 'canevas-check-liste-etude-faisabilite-marche',
    ],
    'ChecklistSuiviAnalyseFaisabiliteFinanciereSeeder' => [
        'method' => 'getCanevasChecklisteSuiviAnalyseDeFaisabiliteFinanciere',
        'categorie_slug' => 'canevas-check-liste-de-suivi-analyse-de-faisabilite-financiere',
    ],
    'ChecklistEtudeFaisabiliteOrganisationnelleJuridiqueSeeder' => [
        'method' => 'getCanevasChecklisteEtudeFaisabiliteOrganisationnelleEtJuridique',
        'categorie_slug' => 'canevas-check-liste-de-suivi-etude-de-faisabilite-organisationnelle-juridique',
    ],
    'ChecklistSuiviEtudeImpactEnvironnementaleSocialeSeeder' => [
        'method' => 'getCanevasChecklisteSuiviEtudeImpactEnvironnementaleEtSociale',
        'categorie_slug' => 'canevas-check-liste-de-suivi-etude-analyse-impact-environnementale-sociale',
    ],
    'ChecklistSuiviAssuranceQualiteRapportFaisabiliteSeeder' => [
        'method' => 'getCanevasChecklisteSuiviAssuranceQualiteRapportEtudeFaisabilite',
        'categorie_slug' => 'canevas-check-liste-suivi-assurance-qualite-rapport-etude-faisabilite',
    ],
];
...
echo "🔍 Extraction et régénération des seeders de checklists...\n\n";

foreach ($checklists as $seederName => $config) {
    echo "📄 Traitement: {$seederName}\n";

    $method = $config['method'];
    $canevas = $documentRepo->$method();
    ...
    $resource = new \App\Http\Resources\CanevasAppreciationTdrResource($canevas);
